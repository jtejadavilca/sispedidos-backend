...
CREATE TABLE IF NOT EXISTS `bd_syspedidos`.`tb_empleado` (
  ...
  `tb_datos_personales_id` INT NOT NULL,
  ...
  INDEX `fk_tb_empleado_tb_datos_personales1_idx` (`tb_datos_personales_id` ASC),
  CONSTRAINT `fk_tb_empleado_tb_datos_personales1`
...
CREATE TABLE IF NOT EXISTS `bd_syspedidos`.`tb_persona_contacto` (
  ...
  INDEX `fk_tb_persona_contacto_tb_datos_personales1_idx` (`tb_datos_personales_id` ASC),
  CONSTRAINT `fk_tb_persona_contacto_tb_cliente1`
    FOREIGN KEY (`tb_cliente_id`)
    REFERENCES `bd_syspedidos`.`tb_cliente` (`tb_cliente_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_persona_contacto_tb_datos_personales1`
    FOREIGN KEY (`tb_datos_personales_id`)
    REFERENCES `bd_syspedidos`.`tb_datos_personales` (`tb_datos_personales_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `bd_syspedidos`.`tb_ubigeo` (
  `tb_ubigeo_id` VARCHAR(6) NOT NULL COMMENT 'Ej: 010000 -> Amazonas\nEj: 020601 -> Carhuaz',
...
CREATE TABLE IF NOT EXISTS `bd_syspedidos`.`tb_direccion` (
  ...
  `tb_ubigeo_id` VARCHAR(6) NOT NULL,
